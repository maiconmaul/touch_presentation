                    ...
                    <div className="left">
                        {
                            units.map((unit, index) => {
                                return (
                                    <ActionButton key={unit.name} title={unit.name} extraClass={selectedIndex === index ? "selected" : ""} onClick={() => handleSelection(index)} />
                                )
                            })
                        }
                    </div>
...
export default MillenniumUnitsPage