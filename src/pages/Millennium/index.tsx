...
import building from '../../assets/img/fachada/millennium-fachada.jpg'


import './style.css'

function MillenniumIndex() {
    ...
    return (
        <div id="page-millennium-index" className="fade-in">
            <div className="side-menu">
                ...
                <div className="button-container">
                    ...
                    <ImageButton title="Projeto" image={projectIcon} extraClass="slide-left" link="/millennium/projeto"/>
                    <ImageButton title="Áreas Comuns" image={commonAreasIcon} extraClass="slide-right" link="/millennium/areascomuns"/>
                    <ImageButton title="Unidades" image={unitsIcon} extraClass="slide-left" link="/millennium/unidades"/>
...
export default MillenniumIndex;