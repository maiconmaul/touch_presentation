...
import complexoBuilding from '../../assets/img/fachada/highline-fachada.jpg'


import './style.css'

function HighlineIndex() {
        ...
        <div id="page-complexo-index" className="fade-in">
            <div className="side-menu">
                ...
                <div className="button-container">
                    ...
                    <ImageButton title="Projeto" image={projectIcon} extraClass="slide-left" link="/highline/projeto"/>
                    <ImageButton title="Áreas Comuns" image={commonAreasIcon} extraClass="slide-right" link="/highline/areascomuns"/>
                    <ImageButton title="Unidades" image={unitsIcon} extraClass="slide-left" link="/highline/unidades"/>
