                            ...
                            selectedIndex === 0 ?
                                <>
                                    ...
                                    <div className="image-container">
                                        <img src={apto55} alt="" />
                                        {/* suite */}
                                        <ZoneButton x={460} y={280} height={300} width={340} onClick={() => history.push("/highline/areascomuns/galeria/0/0")}/> 
                                        {/* sala */}
                                        <ZoneButton x={200} y={300} height={280} width={260} onClick={() => history.push("/highline/areascomuns/galeria/0/1")}/>
                                        {/* varanda */}
                                        <ZoneButton x={200} y={580} height={200} width={280} onClick={() => history.push("/highline/areascomuns/galeria/0/2")}/> 
                            ...
                            selectedIndex === 2 ?
                                <>
                                    ...
                                    <div className="image-container">
                                        <img src={apto79} alt="" />
                                        {/* sala */}
                                        <ZoneButton x={610} y={270} height={310} width={300} onClick={() => history.push("/highline/areascomuns/galeria/2/0")} /> 
                                        {/* suite */}
                                        <ZoneButton x={20} y={180} height={410} width={320} onClick={() => history.push("/highline/areascomuns/galeria/2/1")} /> 
                                        {/* varanda */}
                                        <ZoneButton x={615} y={590} height={190} width={290} onClick={() => history.push("/highline/areascomuns/galeria/2/2")} /> 
                                    </div>
                                    <div className="text-container">
                                        <span>2 DORMITÓRIOS C/ 1 SUÍTE</span>
                                    </div>
